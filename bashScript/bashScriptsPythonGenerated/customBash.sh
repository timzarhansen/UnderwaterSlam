...
ros2 run underwaterslam odometryTest --ros-args --params-file /home/tim-external/ros_ws/src/UnderwaterSlam/params/pythonGeneratedParams/customConfig.yaml & >/dev/null 2>&1
pid1=$!
